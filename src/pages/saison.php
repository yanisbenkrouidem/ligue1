...
$top_buteurs = [
    ['nom' => 'K. MbappÃ©', 'club' => 'Paris', 'stat' => 27, 'logo' => 'paris.png'],
...
$top_passeurs = [
    ['nom' => 'O. DembÃ©lÃ©', 'club' => 'Paris', 'stat' => 8, 'logo' => 'paris.png'],
...
function getFormIcon($result) {
    if ($result === 'W') return '<span class="forme-badge forme-w">âœ“</span>';
    if ($result === 'D') return '<span class="forme-badge forme-d">-</span>';
    return '<span class="forme-badge forme-l">âœ•</span>';
}
?>
<!DOCTYPE html>
<html lang="fr">
